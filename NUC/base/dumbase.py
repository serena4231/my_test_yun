...
Comm = {
    'SCREEN_ON':'adb shell input keyevent 26',
    'UNLOCK':'adb shell input swipe 632 632 1280 766',
    'C_DUMP':'adb shell uiautomator',
    'P_DUMP':'adb pull /var/log/uidump.txt ',
    'HOME':'adb shell input keyevent 3',
    'BACK':'adb shell input keyevent 4',
    'DELETE':'adb shell input keyevent --longpress 67',
    'SWIPE_SETTING':'adb shell input swipe 99 642 92 121',
    'OPENSETTING':'adb shell sendlink "page://settings.yunos.com/settings"',
    'SYSTEM_STTING':'adb shell input tap 98 645',
    'RECOVERY_SYSTEM':'adb shell input tap 49 78',
    'RECOVER':'adb shell input tap 445 682',
    'FINISH_RECOVER':'adb shell input tap 511 688',
    'DISPLAY':'adb shell input tap 93 365',
    'LOCK_DISPLAY':'adb shell input tap 49 258',
    'DISPLAY_NEVER':'adb shell input tap 82 580',
    'REBOOT':'adb reboot',
    'START_SETTING':'adb shell input tap 500 742',
    'CHOOSE_UNINSTALL_RECOVERY':'adb shell input tap 100 214',
    'CHOOSE_FORMAT_RECOVERY':'adb shell input tap 100 260',
    'VOLUME':'adb shell input tap 100 445',
    'VOLUME_UP':'adb shell input tap 800 200',
    'VOLUME_DOWN':'adb shell input tap 100 200',
    'VOLUME_UP_TO_DOWN':'adb shell input swipe 800 200 100 200',
    'VOLUME_DOWN_TO_UP':'adb shell input swipe 100 200 800 200',
    'KEY_VOLUME_LONG_UP':'adb shell input keyevent --longpress 24',
    'KEY_VOLUME_LONG_DOWN':'adb shell input keyevent --longpress 25',
    'KEY_VOLUME_MUTE':'adb shell input keyevent 91'
}
